    ...
    if (isOpen) {
      const fetchEventos = async () => {
        ...
        if (data && data.length > 0) {
          ...
          // Datos de prueba
          setEventos([
            { ID_Evento: '1', Nombre: 'Exposición de Proyectos de Grado', Fecha: '2026-05-15T09:00:00Z', Ubicacion: 'Edificio A, Planta Baja' },
          ...
          <>
            ...
            >
              ...
              <div className="flex items-center justify-between px-[30px] w-full mb-[20px] shrink-0">
                <div className="flex gap-[15px] items-center">
                  ...
                  <div className="flex flex-col font-['Plus_Jakarta_Sans']">
                    ...
                    <span className="font-medium text-gray-500 text-[14px]">Próximas actividades</span>
                  </div>
                </div>
                <button
                  onClick={onClose}
              ...
              <div className="flex-1 overflow-y-auto px-[30px] flex flex-col gap-3 pb-[100px] font-['Plus_Jakarta_Sans']">
                {loading ? (
                  <Spinner text="Cargando próximos eventos..." />
                ) : filtrados.length === 0 ? (
                  ...
                  filtrados.map((evt) => {
                    ...
                    const ubicacion = evt.Ubicacion || evt.Lugar || 'Ubicación no especificada';
