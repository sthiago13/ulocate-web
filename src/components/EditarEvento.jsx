          ...
          >
            ...
            <div className="flex-1 flex flex-col gap-5 font-['Plus_Jakarta_Sans'] mt-4">
              ...
              <InputField
                ...
                placeholder="Ej. Feria de Innovaci├│n"
              />
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between">
                  <label className="text-[14px] font-medium text-gray-700">Breve Descripci├│n</label>
                ...
                <textarea
                  ...
                  placeholder="Detalles sobre de qu├® trata el evento..."
                />
              </div>
            </div>
