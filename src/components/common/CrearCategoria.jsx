          ...
          >
            ...
            <div className="flex items-center justify-between w-full mb-[30px]">
              <div className="flex gap-[15px] items-center">
                ...
                <div className="flex flex-col font-['Plus_Jakarta_Sans']">
                  <span className="font-bold text-[#101828] text-[20px] leading-[26px]">Nueva Categor├¡a</span>
                  <span className="font-semibold text-amber-600 text-[14px]">Agregando secci├│n</span>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="flex-1 flex flex-col gap-5 font-['Plus_Jakarta_Sans'] mt-4">
              <InputField
                ...
                placeholder="Ej. Acad├®mico, Recreaci├│n..."
              />

              <InputField
                label="Nombre del ├ìcono (Opcional)"
                value={icono}
