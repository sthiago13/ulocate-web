...
export default function AdministracionPanel({ onClose, onOpenEditorLugar }) {
  const adminAreas = [
    { label: "Gestionar Lugares", icon: MdPlace, action: onOpenEditorLugar || (() => console.log('Lugares')) },
